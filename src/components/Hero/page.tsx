    ...
    return (
        ...
        <div className="flex h-full  flex-col md:flex-row m-6 relative">
          ...
          alt="Picture of the author"/>
            ...
            <Image className="sm:m-6 w-[75px] h-[75px] md:w-[100px] md:h-[100px] z-50 absolute hidden lg:inline-block lg:right-[550px]" style={{transform: `translateX(${offsetY * 1.5}px)` }}
          src={Star} 
          width={50}
          height={50}
          alt="Picture of the author"/>
